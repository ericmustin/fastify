...
var validate = (function() {
  ...
  return function validate(data, dataPath, parentData, parentDataProperty, rootData) {
    ...
    if ((data && typeof data === "object" && !Array.isArray(data))) {
      ...
      if (data.http2SessionTimeout === undefined) data.http2SessionTimeout = 60000;
      var errs__0 = errors;
      var valid1 = true;
...
module.exports.defaultInitOptions = {"bodyLimit":1048576,"caseSensitive":true,"disableRequestLogging":false,"ignoreTrailingSlash":false,"maxParamLength":100,"onProtoPoisoning":"error","onConstructorPoisoning":"ignore","pluginTimeout":10000,"requestIdHeader":"request-id","requestIdLogLabel":"reqId","http2SessionTimeout":60000}
